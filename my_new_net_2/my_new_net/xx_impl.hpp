...
void TcpSocket::doSendAsync(std::size_t lastLengthSent)
{
    ...
    m_sock->async_send(boost::asio::buffer(bufData, bufSize), /*用std::bind会出错*/boost::bind(&TcpSocket::doSendAsyncHandler, this, boost::asio::placeholders::error, boost::asio::placeholders::bytes_transferred));
}
